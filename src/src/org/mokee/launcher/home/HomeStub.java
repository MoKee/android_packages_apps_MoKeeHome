...
import org.mokee.launcher.cardprovider.DashClockExtensionCardProvider;
import org.mokee.launcher.cardprovider.ICardProvider;
import org.mokee.launcher.cardprovider.ICardProvider.CardProviderUpdateResult;
import org.mokee.launcher.cards.SimpleMessageCard;
    ...
    private class LoadAllCardsTask extends AsyncTask<Void, Void, List<Card>> {
        ...
        protected void onPostExecute(List<Card> cards) {
            ...
            CardListView cardListView =
                    (CardListView) mHomeLayout.findViewById(R.id.mk_home_cards_list);
